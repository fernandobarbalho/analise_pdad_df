---
title: "storytelling pdad - deslocamento unidades de ensino"
...
```{r cars}
#Gráfico da distribuição dos tempos para o UE
...
PDAD_2021_Moradores%>%
  ...
  geom_text(aes(label=paste0(proporcao_valido,"%")),
            hjust = c(rep(1,4),rep(-0.1,5)), 
            color = c(rep("white",4),rep("black",5)),
            size =3)+
  theme_light()+
  theme(panel.grid = element_blank(),
        axis.text.x = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF",
...
PDAD_2021_Moradores %>%
  mutate(mesma_regiao = ifelse(a01ra==h04|h04==0 ,"sim","não")) %>%
  filter(!h06%in%c(88888,99999)) %>%
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF: a pé",
    subtitle = "Regiões administrativas/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF: automóvel",
    subtitle = "Regiões administrativas/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF: ônibus",
    subtitle = "Regiões administrativas/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF: Sudoeste e Octogonal",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF: Plano Piloto",
    subtitle = "Meio de transporte/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF: Ceilândia",
    subtitle = "Meio de transporte/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para UE no DF: Brazlândia",
    subtitle = "Meio de transporte/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
```{r fig.height=8}
#Gráfico da distribuição dos tempos para o UE por região administrativa
