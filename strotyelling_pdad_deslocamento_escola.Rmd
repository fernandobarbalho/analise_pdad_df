...
names(tempos_unidade_ensino)<- c("i10","tempo_deslocamento")
...
```{r cars}
#Gráfico da distribuição dos tempos para o unidade_ensino
...
PDAD_2021_Moradores%>%
  ...
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF: a pé",
    subtitle = "Regiões administrativas/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF: automóvel",
    subtitle = "Regiões administrativas/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF: ônibus",
    subtitle = "Regiões administrativas/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF: Sudoeste e Octogonal",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF: Plano Piloto",
    subtitle = "Meio de transporte/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF: Ceilândia",
    subtitle = "Meio de transporte/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
PDAD_2021_Moradores %>%
  ...
  theme(panel.grid = element_blank()) +
  labs(
    title = "Tempos de deslocamento para unidade_ensino no DF: Brazlândia",
    subtitle = "Meio de transporte/mesma região (s/n)",
    caption = "Fonte: IPE-DF. Dados de 2021. Elaboração própria",
    x="Proporção do total de deslocamentos (%)",
    y="",
...
```{r fig.height=8}
#Gráfico da distribuição dos tempos para o unidade_ensino por região administrativa
